...
| Item | Key | Status |
|---|---|---|
| Capstone-01 — Find a Team [#5](https://github.com/chew-Lo/csci4208-portfolio-2025/issues/5) | `capstone-01` | open |
...
| Project-0 — Set up Repo, Project Board, Actions & Pages [#8](https://github.com/chew-Lo/csci4208-portfolio-2025/issues/8) | `project-00` | open |
